...
const Header = () => {
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-gray-800 text-center'>
      ...
      <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Welcome to our App Auth </h2>
      <p className='mb-8 max-w-md'>Lets start with a quick product tour and we will have you up running in no time! </p>
